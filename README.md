...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/scrape-youtube-search-results?style=social)](https://github.com/data-scrape/scrape-youtube-search-results)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/scrape-youtube-search-results?style=social)](https://github.com/data-scrape/scrape-youtube-search-results/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/scrape-youtube-search-results)](https://github.com/data-scrape/scrape-youtube-search-results/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/scrape-youtube-search-results)](https://github.com/data-scrape/scrape-youtube-search-results/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Scrape YouTube search results - extract videos, channels, playlists


<!-- SEO keywords: scrape youtube search results, Scrape Youtube Search Results, scrape youtube search results python, scrape youtube search results github -->
...
- Scrape YouTube search results for any query
- Video titles, URLs, durations, view counts
- Channel name and subscriber count
- Video upload date and thumbnail URL
- Filter by upload date, duration, type
- Playlist and channel results extraction

## 🎯 Use Cases

Track video rankings for SEO, monitor competitor content.
...
```bash
pip install git+https://github.com/data-scrape/scrape-youtube-search-results.git
```

### From source

```bash
git clone https://github.com/data-scrape/scrape-youtube-search-results.git
cd scrape-youtube-search-results
pip install -e .
```
...
```python
from scrape_youtube_search_results import Scraper
...
```bash
python scrape_youtube_search_results.py --query "your-query" --output results.json
```
...
### Is Scrape Youtube Search Results legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/scrape-youtube-search-results)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/scrape-youtube-search-results/issues)
